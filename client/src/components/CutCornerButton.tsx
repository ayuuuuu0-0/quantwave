...
export const CutCornerButton = (props: ComponentPropsWithoutRef<"button">) => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 outline outline-2 -outline-offset-2 outline-fuchsia-500 [mask:linear-gradient(225deg,transparent_0,transparent_10px,black_10px)]"></div>
      <svg
        width="24"
        height="24"
        viewBox="0 0 24 24"
