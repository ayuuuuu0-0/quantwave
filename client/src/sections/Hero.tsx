...
export const HeroSection = () => {
  ...
  const torusRotate = useTransform(torusScrollYProgress, [0, 1], [40, -40]);

  const cuboidRotate = useTransform(cuboidScrollYProgress, [0, 1], [40, -40]);

  return (
    <section className="py-24 md:py-52 overflow-x-clip">
      <div className="container">
        <p className="uppercase font-extrabold text-center text-zinc-500 tracking-wider">
          Introducing QuantWave
        </p>
        <h1 className="font-heading font-black text-5xl md:text-6xl lg:text-7xl text-center mt-4 max-w-3xl mx-auto">
          The Future of Blockchain is Here.
        </h1>
        <p className="text-center text-xl mt-6 text-zinc-400 max-w-xl mx-auto">
          QuantWave is pioneering smart contract integrity with cutting-edge
          data solutions.
        </p>
        ...
        <div className="flex justify-center mt-24">
          <div className="inline-flex mt-24 relative z-0">
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
              <Hexagon
                className="size-[1800px] lg:size-[1900px]"
                size={1800}
                reverse
                duration={60}
              />
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
              <Circle
                className="absolute left-[200px] -top-[900px] lg:-top-[950px]
              "
                animate
              >
                <motion.img
