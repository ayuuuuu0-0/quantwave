...
const cardData = [
  {
    ...
    description:
      "Effortly integrate and manage blockchain data with our cutting-edge API, designed for seamless connectivity.",
    color: "fuchsia",
  },
  {
    ...
    description:
      "Empower your applications with decentralized data storage solutions, built on the latest blockchain technology.",
    color: "lime",
  },
  {
    ...
    description:
      "Unlock the potential of smart contracts with our advanced development tools, designed for the future of blockchain.",
    color: "cyan",
  },
  {
    image: "/assets/images/icosahedron.png",
    title: "Seamless Blochain Integration",
    description:
    ...
    <section className="py-24 overflow-x-clip md:-mt-28">
      <div className="container">
        <h2 className="font-heading font-black text-4xl md:text-5xl lg:text-6xl text-center ">
          Discover the future of blockchain with QuantWave
        </h2>
